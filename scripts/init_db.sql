...
-- INSERT INTO BrokenPipe (date, broken_type, size, pipe_type, broken_specification, district, amount, reason, material, pipe_material, manufacturer, installed_date, thickness) VALUES
